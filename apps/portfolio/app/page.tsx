...
import { Sponsors } from "@apru/ui";
import { Curtain } from "@/components/motion/Curtain";
import { Preloader } from "@/components/motion/Preloader";
import { MaskLines, Reveal } from "@apru/ui";
        ...
        <div className="flex flex-col gap-[60rem] max-md:gap-[40rem]">
          ...
          <Reveal>
            <div className="t-b1 flex max-w-[70ch] flex-col gap-[26rem]">
              {/* The theme statement, from the approved content document. It
                  was written out here and again on the client edition's About
                  page; both now read the one copy. */}
