...
export const metadata = pageMetadata({
  ...
  description:
    "The eleven ongoing thematic working groups of the APRU Sustainable Cities and Landscapes network, convening at the 10th conference in Singapore.",
  ...
  return (
    <>
      <PageHead
        label="Highlight"
        title={["Working", "groups"]}
        lede="Eleven ongoing thematic groups convening across the Pacific Rim, each led from a member university."
      />

      {/* The darkening. 200vh, pinned, black rising from the bottom edge. */}
      <Curtain label="Working groups" halo="right">
